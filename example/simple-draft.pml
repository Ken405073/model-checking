/* Information structure for this model, R1=={1,2}, R2=={1,2}, I1=={1}, I2=={2} */

mtype={req,rel,gr}; /* request, release, grant */
...
active proctype P1(){
  ...
  /* no need to define the singleton sets I1={1} and St1={1} */
...
L1:
    ...
    if
      ...
      ::msg==rel-> /* remove the corresponding element from the priority queue
                    * to achieve this we make use of a tmp channel */
        do
        ::empty(q1)-> break;
        ::q1?item -> if
                     ::item != u*4+r -> tmp!item
...
CS1: /* critical section */
    ...
    /* after the CS, we send release message(s) */
    sr[0]!rel,1,t[0],clk[0]; 
